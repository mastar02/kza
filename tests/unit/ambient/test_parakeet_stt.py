"""Tests: ParakeetSTT — motor ASR del ambient path (swap 2026-06-07).
...
5/5 del turbo, mejor calidad en voz, RTF ~0.03 en CPU (0 VRAM). El command
path sigue en turbo GPU; esto solo reemplaza el STT del ambient path.
"""
